"""
btcaaron.network.utxo - UTXO fetch and selection utilities

Reusable for legacy quick_transfer and v0.2 SpendBuilder flows.
"""
...
def select_utxos(
    ...
    Args:
        ...
        strategy: "largest_first" (greedy by amount) or "smallest_first"
